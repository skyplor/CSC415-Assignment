...
//    }
    ...
    private Query computeTopTermQuery(Directory ramdir) throws Exception
    {
        ...
        Collections.sort(termlist, null);//new ReverseComparator<String>(new ByValueComparator<String, Integer>(frequencyMap)));
    ...
    private String[] searchIndex(Directory ramdir, Query query) throws Exception
    {
        ...
        for (ScoreDoc scoreDoc : topDocs.scoreDocs)
        {
            ...
            sentenceMap.put(scoreDoc.doc, doc.get("text"));//StringUtils.chomp(doc.get("text")));
        }
        searcher.close();
